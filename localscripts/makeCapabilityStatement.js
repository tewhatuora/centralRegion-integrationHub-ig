...
if (fs.existsSync(rootPath)) {
    ...
    arFiles.forEach(function (name) {
        ...
        if (name.startsWith('CapabilityStatement')) {
            ...
            ar.push("<div>");
            ar.push(`<a href="${capStmt.id}.openapi.json" no-download="true">Raw OpenAPI Definition file</a> | <a download="${capStmt.id}.openapi" href="${capStmt.id}.openapi.json">Download</a>`);
            ar.push("</div>");
