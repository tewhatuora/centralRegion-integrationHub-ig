...
* insert cmapEntry(R09, "Buddhist",              1058, "Zen Buddhism")
...
* insert cmapEntry(R20, "Jehovahs Witness",      1025, "Jehovahs Witness")
...
* insert cmapEntry(R28, "Open Bretheren",        1062, "Bretheren")
