...
* clinicalStatus
  * coding
    * code -> "ZAL-5 & ZAL-9" "**if** ZAL-5 is in the past **AND** ZAL-9 is in the future or empty\r\n
    **then** 'active'\r\n
    **else** 'inactive'"
    
    * system -> "'http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical'"
    * display -> "ZAL-5 & ZAL-9" "**if** ZAL-5 is in the past **AND** ZAL-9 is in the future or empty\r\n
    **then** 'Active'\r\n
    **else** 'Inactive'"
